...
function NoteFooter() {
  return (
    <footer className="w-full py-4 px-6 border-t border-zinc-200 bg-white text-zinc-500 text-xs flex flex-col sm:flex-row items-center justify-between gap-2">
